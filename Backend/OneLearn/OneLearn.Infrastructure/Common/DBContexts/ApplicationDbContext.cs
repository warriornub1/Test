...
using OneLearn.Domain.Transactions.User;
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                new Role { RoleName = "Admin", IsActive = true, IsDeleted = false, created_by = "Auto", created_on = new DateTime(22024, 12, 26) },
                new Role { RoleName = "User", IsActive = true, IsDeleted = false, created_by = "Auto", created_on = new DateTime(22024, 12, 26) }
            );
        }
