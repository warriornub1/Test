...
{
    /// <inheritdoc />
    public partial class UserType_asd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePrivillege", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "Address", "DepartmentId", "Email", "StudentName" },
                values: new object[,]
                {
                    { 1, "India", null, "asd@gmail.com", "Venkat" },
                    { 2, "India", null, "asd1@gmail.com", "Neahnth" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePrivillege_RoleId",
                table: "RolePrivillege",
                column: "RoleId");
